...
class CreateValueObject extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'make:valueObject
                            {--N|name=ValueObject : Class Name}
    ...
    public function handle()
    {
        if (! is_dir($directory = app()->path() . DIRECTORY_SEPARATOR . ($this->option('path') ?:
                'ES' . DIRECTORY_SEPARATOR . 'ValueObjects'))) {
    ...
    {
        $compiledStub = file_get_contents(__DIR__.'/stubs/ValueObject.stub');
